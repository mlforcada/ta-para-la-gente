...
\begin{center}
\begin{tabular}{ccccc}
\framebox{\parbox{2.2cm}{\raggedright\includegraphics[scale=0.07]{text.png}\\\textbf{Texto en lengua origen}}} & $\to$ & \framebox{\parbox{2.2cm}{\includegraphics[scale=0.15]{computer-gearbox.jpg}\\Sistema de \\ traducción
    \\ automática}} & $\to$ & 
