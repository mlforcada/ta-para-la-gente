...
La traducción automática \textbf{neuronal} aparece en 2013 (hubo precursores en 1997).
...
\begin{itemize}
\item Ha aprendido a construir internamente \textbf{representaciones}
  \begin{itemize}
...
\begin{frame}
  ...
  \item \emph{Aprendió a afeitarse en treinta segundos.}
    ...
    \item \emph{\framebox{aprendió a} \framebox{afeitarse \framebox{en treinta segundos}}} 
...
\begin{frame}
  ...
  \item \emph{Trajo noticias de Grecia}
    ...
    \item \emph{\framebox{Trajo}\framebox{noticias \framebox{de Grecia}}}
    \item \emph{\framebox{Trajo \framebox{noticias}} \framebox{de Grecia}}
    \end{itemize}
...
\begin{frame}
\frametitle{Retos /4}
Los sistemas de traducción automática a veces tienen que reordenar completamente la frase:
\begin{center}
  \emph{Donostiako$^1$ gizon$^2$ haundi $^3$ harek$^4$ zekarren$^5$ automobila$^6$} \\ 
  $\downarrow$
  \\
  \emph{[El coche]\ $^6$ [que traía]\ $^5$ aquel$^4$ hombre$^2$ grande$^3$ [de San Sebastián]\ $^1$}  
\end{center}
\end{frame}
